        ...
        <div className="contentWrap">
          ...
          <div className="inputWrap">
            ...
            <div onClick={togglePasswordVisibility}>
              {passwordVisible ? <AiFillEye {{ height: "30px" }}/> : <AiFillEyeInvisible {{ height: "30px" }}/>}
            </div>
          </div>
          ...
          <div className="inputWrap">
            ...
            <div onClick={togglePasswordConfirmVisibility}>
              {passwordConfirmVisible ? <AiFillEye {{ height: "30px" }}/> : <AiFillEyeInvisible {{ height: "30px" }}/>}
            </div>
          </div>
          ...
          <select {...register("region", { required: "지역을 선택해주세요." })}>
          ...
          {watch("region") && (
            <>
              <div className="inputTitle">시/군/구</div>
              <select
                id="subRegion"
                name="subRegion"
                {...register("subRegion", {
