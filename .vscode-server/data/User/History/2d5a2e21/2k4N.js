...
const CommunityList = () => {
  ...
  const sortedPostsByCriteria = (something) => {
    const sorted = [...something].sort((a, b) => {
      switch (sortBy) {
        case "page":
          return b.id - a.id;
        case "date":
    ...
    return sorted.slice(page - 1 * 10, page * 10);
  };
      ...
      <div className="NotDrag">
        ...
        {searchResults.length >= 0 && (
          <table className="table-container">
            ...
            <tbody>
              something1 = {searchResults > 0 ? searchResults : Posts}
              {sortedPostsByCriteria(something1).map((post) => (
